...
function getContextName(context) {
    ...
    if (context) {
        ...
        const stackLine = ((_a = new Error().stack) === null || _a === void 0 ? void 0 : _a.split('\n')[2].trim()) || "";
        // return a default value if the stackLine is empty.
        const errorStackTrace = ((_b = new Error().stack) === null || _b === void 0 ? void 0 : _b.split('\n')) || [
            "Error: Error message",
